# 🎨 Shadcn/UI RadioGroup for Weweb

Beautiful **RadioGroup component** from [shadcn/ui](https://ui.shadcn.com/) adapted for Weweb.

## 🚀 Import in Weweb

1. Copy this repository URL: `https://github.com/YOUR_USERNAME/shadcn-radiogroup`
2. In Weweb editor, open developer panel (F12)
3. Add as "custom element"
4. The RadioGroup component will appear in your elements!
...
├── src/
│   ├── RadioGroup.vue    # Vue.js component
│   ├── cn.js            # CSS utility
